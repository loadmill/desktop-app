...
export const STANDALONE_NPX_FOLDER_PATH = path.join(STANDALONES_PATH, 'standalone_npx');
export const STANDALONE_PLAYWRIGHT_FOLDER_PATH = path.join(STANDALONES_PATH, 'standalone_playwright');
